...
dataset = NPZ_gen(
    ...
    random_scale=0.05, random_crop=None, random_resize=None, random_noise=None
)
...
with tf.Session(config=config) as sess:
    with tf.device(GPU):
        ...
        # x = Dense(6, activation='softmax', kernel_regularizer=l2(5e-5), name='predictions')(x)
