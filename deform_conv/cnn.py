...
def get_cnn(class_n, trainable=True):
	inputs = l = Input((28, 28, 1), name='input')

	# l = ImageNorm()(l)

	# conv11
	# l2 = InvConv2D(32, (3, 3), strides=(2, 2), padding='same', kernel_initializer='Orthogonal', name='conv11_inv')(l)
	# l2 = Activation('relu', name='conv11_inv_relu')(l2)
	# l2 = BatchNormalization(name='conv11_inv_bn')(l2)
    #
	l = Conv2D(32, (3, 3), strides=(2, 2), padding='same', kernel_initializer='Orthogonal', name='conv11')(l)
	l = Activation('relu', name='conv11_relu')(l)
	l = BatchNormalization(name='conv11_bn')(l)
    #
	# l = concatenate([l, l2])
    #
	l = Conv2D(64, (1, 1), padding='same', kernel_initializer='Orthogonal', name='conv11_12')(l)
	l = Activation('relu', name='conv11_12_relu')(l)
	l = BatchNormalization(name='conv11_12_bn')(l)
    #
	# # conv12
	# l2 = InvConv2D(64, (3, 3), padding='same', kernel_initializer='Orthogonal', strides=(2, 2), name='conv13')(l)
	# l2 = Activation('relu', name='conv13_relu')(l2)
	# l2 = BatchNormalization(name='conv13_bn')(l2)
    #
	l = Conv2D(64, (3, 3), padding='same', kernel_initializer='Orthogonal', strides=(2, 2), name='conv12')(l)
	l = Activation('relu', name='conv12_relu')(l)
	l = BatchNormalization(name='conv12_bn')(l)
    #
	# l = concatenate([l, l2])
    #
	l = Conv2D(64, (1, 1), padding='same', kernel_initializer='Orthogonal', name='conv13_21')(l)
	l = Activation('relu', name='conv13_21_relu')(l)
	l = BatchNormalization(name='conv13_21_bn')(l)
    #
	# # conv22
	# l2 = InvConv2D(128, (3, 3), padding='same', kernel_initializer='Orthogonal', name='conv22')(l)
	# l2 = Activation('relu', name='conv22_relu')(l2)
	# l2 = BatchNormalization(name='conv22_bn')(l2)
    #
	# # conv21
	l = Conv2D(128, (3, 3), padding='same', kernel_initializer='Orthogonal', name='conv21')(l)
	l = Activation('relu', name='conv21_relu')(l)
	l = BatchNormalization(name='conv21_bn')(l)

	# l = concatenate([l, l2])
    #
	l = Conv2D(128, (1, 1), padding='same', kernel_initializer='Orthogonal', name='conv22_23')(l)
	l = Activation('relu', name='conv22_23_relu')(l)
	l = BatchNormalization(name='conv22_23_bn')(l)
    #
	# l = Conv2D(128, (3, 3), padding='same', kernel_initializer='Orthogonal', name='conv23')(l)
	# l = Activation('relu', name='conv23_relu')(l)
	# l = BatchNormalization(name='conv23_bn')(l)
    #
	# l = Conv2D(256, (3, 3), strides=(2, 2), padding='same', kernel_initializer='Orthogonal', name='conv31')(l)
	# l = Activation('relu', name='conv31_relu')(l)
	# l = BatchNormalization(name='conv31_bn')(l)
    #
	# l = Conv2D(256, (3, 3), padding='same', kernel_initializer='Orthogonal', name='conv32')(l)
	# l = Activation('relu', name='conv32_relu')(l)
	# l = BatchNormalization(name='conv32_bn')(l)
    #
	# l = Conv2D(512, (3, 3), strides=(2, 2), padding='same', kernel_initializer='Orthogonal', name='conv33')(l)
...
def get_large_deform_cnn(class_num, trainable=False):
	...
	l = Conv2D(64, (3, 3), padding='same', name='conv12', trainable=trainable, kernel_initializer=init, kernel_regularizer=OrthLocalReg2D)(l)
	l = Activation('relu', name='conv12_relu')(l)
	l = BatchNormalization(name='conv12_bn', center=False, scale=False)(l)
...
def large_deform_center_cnn(class_num, trainable=False, GPU=1):
	# init = Orthogonal(gain=1.0, seed=None)
	init = 'random_normal'
